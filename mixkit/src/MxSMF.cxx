/************************************************************************
  ...
  $Id: MxSMF.cxx,v 1.28 1999/02/20 19:47:17 garland Exp $
...
MxStdModel *MxSMFReader::read(int fd, MxStdModel *m)
{
...
#ifndef MIX_ANSI_IOSTREAMS
void MxSMFWriter::write(int fd, MxStdModel& m)
{
